...
<html lang="en">
<head>
  <title>Bootstrap General Knowledge</title>
  <meta charset="utf-8">
...
<br>   
<h2 class="allheading">Bootstrap General Knowledge</h2>
<br>     

<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">1. What does PHP stand for?</div>
        <div class="panel-body">Answer : Hypertext Preprocessor</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">2. Who is the Father of PHP?</div>
        <div class="panel-body">Answer : Rasmus Lerdorf</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">3. What is the expansion of LAMP?</div>
        <div class="panel-body">Answer : Linux Apache Mysql Php</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">4. The PHP syntax is most similar to which?</div>
        <div class="panel-body">Answer : PERL and C</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">5. Is php can support multiple inheritance in PHP?</div>
        <div class="panel-body">Answer : No</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">6. What function used to print statement in PHP?</div>
        <div class="panel-body">Answer : echo();</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">7. In PHP 5 MySQL support is enabled by default or not?</div>
        <div class="panel-body">Answer : No</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">8. All variables in PHP start with which symbol?</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">9. Which of the following is used to declare a constant?</div>
        <div class="panel-body">Answer : Define</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">10. Which operator is used to concatenate two strings in php?</div>
        <div class="panel-body">Answer : dot operator (.)</div>
      </div>
  </div>
</div>
