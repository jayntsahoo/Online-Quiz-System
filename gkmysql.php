...
<html lang="en">
<head>
  <title>MYSQL General Knowledge</title>
  <meta charset="utf-8">
...
<b>
<br>
<h2 class="allheading">MySQL General Knowledge</h2>
<br>       

<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">1. What is an open source DBMS product that runs on UNIX, Linux and Windows.</div>
        <div class="panel-body">Answer : MySQL</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">2. What does SQL stand for?</div>
        <div class="panel-body">Answer : Structured Query Language</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">3. With SQL, how do you select all the columns from a table named "Person"?</div>
        <div class="panel-body">Answer : SELECT * FROM Person </div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">4. Which function used to get the current time in mysql?</div>
        <div class="panel-body">Answer : NOW ()</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">5. Which SQL statement is used to return only different values?</div>
        <div class="panel-body">Answer : SELECT DISTINCT</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">6. Which SQL statement is used to delete data from a database?</div>
        <div class="panel-body">Answer : DELETE</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">7. Which SQL statement is used to insert a new data in a database?</div>
        <div class="panel-body">Answer : INSERT INTO</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">8. What is MySQL?</div>
        <div class="panel-body">Answer : A Relational Database Management System</div>
      </div>
  </div>
</div>
...
<div class="row">
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">9. Which of the following is not a valid aggregate function?</div>
        <div class="panel-body">Answer : COMPUTE</div>
      </div>
  </div>
  <div class="col-sm-6">
      <div class="panel panel-color">
        <div class="panel-heading">10. What is the most common type of join?</div>
        <div class="panel-body">Answer : INNER JOIN</div>
      </div>
  </div>
</div>
