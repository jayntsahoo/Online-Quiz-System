...
<h2 class="allheading">LEARN MYSQL</h2>
...
So nowadays, we use RDBMS to store and manage huge volume of data. This is called relational database because all the data is stored into different tables and relations are established using primary keys or other keys known as foreign keys.</p>

<h3 class="subheading">Further study about MYSQL</h3>
...
<ol>
  <li class="study"><a href="http://www.w3schools.com/sql/" target="_blank">click this link to go to W3schools</a></li>
  <li class="study"><a href="https://www.tutorialspoint.com/mysql/" target="_blank">click this link to go to Tutorialspoint</a></li>
  <li class="study"><a href="http://www.javatpoint.com/mysql-tutorial" target="_blank">click this link to go to Javatpoint</a></li>
</ol>
